...
$sql=("UPDATE PRO_Jobs SET status='Completed' WHERE id ='$job';
       UPDATE PRO_Jobs_assigned SET job_status='Completed' WHERE id='$job';
           INSERT INTO PRO_job_completed(id,status) VALUES('$job','Yes');");
			...
			<div class="navbar navbar-default htlfndr-blue-hover-nav">
				<div class="container">
						...
						<ul class="nav navbar-nav">
							...
							<li><a href="user-page.php#htlfndr-user-tab-2">my jobs</a></li>
							...
							<li  class="dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li><a href="paymentshistory.php">Payments History</a></li>											
									<li><a href="paymentsmethods.php">Payments Methods</a></li>
	...
	<div class="container">
		...
		<main id="htlfndr-main-content" class="htlfndr-main-content" role="main">	
			<article class="htlfndr-thanks-page text-center">
				...
				<img src="images/mail_icon.jpg" alt="mail" />
				<div><h4>We have just sent to you E-mail a letter with complete information about your booking</h4></div>
                                ...
                                <form method="POST" action="review.php">
                                    ...
                                    <input type="hidden" name="contractor" value="<?php echo"$contractor";?>">
                                    <input type="submit" value="Leave Review" class="htlfndr-more-link text-center">
                                </form>
