...
session_start();
include("connect.php");
if(($_SESSION["id_40214842"])!=($_POST['userid']))
{
...
$sql="SELECT * FROM PRO_Rate_Contractor WHERE id='$job' AND contractorfk='$contractorid'";
    ...
    if(mysqli_num_rows($check)==0){
        ...
        $query2="SELECT name FROM PRO_Contractor WHERE id ='$contractorid'";
...
if(logout){
	...
	<div class="container">
		...
		<main id="htlfndr-main-content" role="main">
		  ...
		  <div class="row">
								<div class="col-md-6">	
                                                                    <form method="POST" class="htlfndr-review-form" action="postreview.php?userid=<?php echo"$id";?>">
                  
                                                                    	
                    <h3><?php echo"$jobtitle";?></h3><br>
                    <label>Contractor Name: <?php echo"$contractorname";?></label>
