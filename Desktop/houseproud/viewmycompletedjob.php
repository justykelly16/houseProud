...
session_start();
include("connect.php");
if(($_SESSION["contractorid_40214842"])!=($_POST['conid'])||($_SESSION["admin_40214842"]=='Yes'))
{
   ...
   $admin=$_SESSION["admin_40214842"];
    ...
    $lastname=$_SESSION['lastname_40214842'];
     ...
     $query="SELECT PRO_User.id, PRO_User.firstname, PRO_User.lastname, PRO_Post_Task.job_title, PRO_Post_Task.Description, 
...
$sql="SELECT * FROM PRO_rate_client WHERE jobfk = '$jobid1'";
    ...
    function send_message()
{
 ...
 return false;
      ...
      while($row= mysqli_fetch_assoc($result)){
				...
				<p class='htlfndr-details'><a href='userprofile.php?userid=$clientid'<span>Client: </span> <span>$clientfirstname $clientlastname</span></a></p>
						...
						<p>$descript</p>
                                     ...
                                     <p class='htlfndr-details'><span>Job Price: </span> <span>&pound$price</span></p>
                                         <p class='htlfndr-details'><span>Service fee: </span> <span>&pound$servicefee</span></p>
                                             <p class='htlfndr-details'><span>Total: </span> <span>&pound$total</span></p>
                                        </div>
                                                    ";
                        ...
                        echo"
                                               ...
                                               <form action='reviewclient.php' method='POST'>
