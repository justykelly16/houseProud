...
if(!isset($_SESSION["id_40214842"])&&(($_SESSION["admin_40214842"])=='No'))
{
    ...
    $sql="SELECT * FROM PRO_report_admin";
                                  ...
                                  <?php }else{
                                    ...
                                    <?php if(mysqli_num_rows($result)>0){
                                        while($row= mysqli_fetch_assoc($result)){
                                          ...
                                          echo"<tr>
								<td class='htlfndr-scope-row'><a href='userprofile.php?userid=$sentbyid'><button class='btn-primary'>View</button></a> </td>
                                                                    <td data-title='Reportt page'><a href='$page'><button class='btn-primary'>View</button></a> </td>
								<td data-title='Message'>$message</td>
								
                                                                    <td><a href='issuewarning.php?cid=$conid'><input type='submit' value='Issue Warning' class='btn-primary'></a></td>
                                                                 <td><a href='removecontractor.php?cid=$conid'><input type='submit' value='Remove' class='btn-primary'></a></td>
							</tr>
                                              ";
